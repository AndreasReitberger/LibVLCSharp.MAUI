...
namespace LibVLCSharp.MAUI.Platforms.Android
{
    ...
    public class OrientationHandler : IOrientationHandler
    {
        ...
        public void LockOrientation()
        {
            ...
            DisplayOrientation orientation = DeviceDisplay.MainDisplayInfo.Orientation; // GetScreenOrientation();
        ...
        [Obsolete("Use DeviceDisplay.MainDisplayInfo.Orientation instead")]
